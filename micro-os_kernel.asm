...
; loading message:
msg  db "Loading kernal module 1 of 1 ......", 0Dh,0Ah
     db "Initializing i/o devices .........", 0Dh,0Ah, 0
     db " ", 0Dh,0Ah 
;==== data section =====================

; welcome message:
msg2  db "Welcome to hackfodder-os!", 0  
...
help_msg db "The short list of supported commands:", 0Dh,0Ah
         ...
         db "ls     - list files in working directory.", 0Dh,0Ah
         db "cls    - clear the screen.", 0Dh,0Ah
         db "reboot - reboot the machine.", 0Dh,0Ah
         db "exit   - shutdown the machine.", 0Dh,0Ah
         db "For full documentation and project info", 0Dh,0Ah
         db "visit http://www.hackfodder.co.uk/hack-os", 0Dh,0Ah
         db "For latest functionality check version details.", 0Dh,0Ah, 0

ls_msg   db "dev    lost+found    ramdisk   tmp", 0Dh,0Ah
         db "bin    ect           mnt       root", 0Dh,0Ah
         db "usr    boot          home      opt", 0Dh,0Ah
         db "sbin   var           clib      cdrom", 0Dh,0Ah
         db "lib    proc          sys       hackfodder", 0Dh,0Ah
         db ".      ..", 0Dh,0Ah
         db "", 0Dh,0Ah
         db "", 0Dh,0Ah
         db "", 0Dh,0Ah, 0
...
; compare command buffer with 'ls'
lea     si, command_buffer
mov     cx, cls_tail - offset cls   ; size of ['help',0] string.
lea     di, cls
repe    cmpsb
je      ls_command
